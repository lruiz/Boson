 ...
 */
@Deprecated
public class MapAdapterFactory extends TypeAdapterRegistryImpl.Component implements ContainerAdapterFactory<MapAdapter> {
    public MapAdapter create(Class<?> type) {
        return new MapAdapter(type);
    }

    public void register(TypeAdapterRegistryImpl adapterManager) {
        adapterManager.register(Map.class, this);
        adapterManager.register(HashMap.class, this);
    }
}